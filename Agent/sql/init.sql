...
CREATE TABLE IF NOT EXISTS session_tag_relation (
    session_id BIGINT NOT NULL,
...
INSERT INTO prompt_template (title, content) VALUES
...
INSERT INTO model_config (model_name, api_key, endpoint, status) VALUES
