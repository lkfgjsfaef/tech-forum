package com.example.forum.web.front.shortlink.rest;
...
import com.example.forum.api.model.vo.shortlink.ShortLinkReq;
...
public class ShortLinkController {
    ...
    private QrResource getDefaultLogo() {
        BufferedImage img;
        try {
            img = ImageLoadUtil.getImageByPath(SpringUtil.getConfigOrElse("view.site.websiteFaviconIconUrl", "/img/icon.png"));
        } catch (Exception e) {
            return null;
        }
