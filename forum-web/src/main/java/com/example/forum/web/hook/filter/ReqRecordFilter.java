...
import com.example.forum.core.util.CrossUtil;
import com.example.forum.core.util.EnvUtil;
...
import com.example.forum.service.sitemap.service.impl.SitemapServiceImpl;
...
public class ReqRecordFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            // 一个链路请求完毕，清空MDC相关的变量如GlobalTraceId，用户信息"
            MdcUtil.clear();
