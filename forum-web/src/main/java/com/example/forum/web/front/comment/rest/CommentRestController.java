package com.example.forum.web.front.comment.rest;
...
import com.example.forum.service.article.conveter.ArticleConverter;
...
import com.example.forum.web.front.comment.vo.CommentPageVo;
import com.example.forum.web.front.comment.vo.HighlightCommentVo;
...
public class CommentRestController {
    ...
    public ResVo<List<TopCommentDTO>> list(Long articleId, Long pageNum, Long pageSize) {
        if (NumUtil.nullOrZero(articleId, true)) {
    ...
    public ResVo<SubCommentListVO> getSubComments(
        ...
        if (NumUtil.nullOrZero(topCommentId, true)) {
